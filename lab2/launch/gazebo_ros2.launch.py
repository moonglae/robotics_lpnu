...
def generate_launch_description():
    ...
    return LaunchDescription([
        # 1. Запуск Gazebo з твоїм світом і роботом
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(gz_sim_launch),
            launch_arguments={'gz_args': [world_file]}.items(),
        ),

        # 2. Запуск моста між Gazebo та ROS2
        Node(
        ...
        # 3. Запуск RViz2 для візуалізації (поки закоментуємо, щоб не видавало помилку через відсутність файлу конфігу)
        # Node(
        #     package='rviz2',
        #     executable='rviz2',
        #     name='rviz2',
